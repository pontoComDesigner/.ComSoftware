object dm: Tdm
  ...
  object drive: TFDPhysMySQLDriverLink
    VendorLib = 'C:\PDV\PDV\Win32\Debug\db\libmysql.dll'
    OnDriverCreated = driveDriverCreated
    Left = 476
    Top = 8
  end
  object fb_Cargoscargo: TFDTable
    IndexFieldNames = 'id'
    Connection = fd
  ...
  object query_usuarios: TFDQuery
    ...
    object query_usuariosid_funcionario: TStringField
      DisplayLabel = 'ID_Funcionario'
  ...
  object fb_fornecedores: TFDTable
    IndexFieldNames = 'id'
    Connection = fd
  ...
  object query_produtos: TFDQuery
    ...
    object query_produtosdata: TDateTimeField
      DisplayLabel = 'DATA'
      DisplayWidth = 12
      FieldName = 'data'
      Origin = 'data'
    ...
    object query_produtosund: TStringField
      DisplayLabel = 'UNIDADE'
      FieldName = 'und'
      Origin = 'und'
      Required = True
    end
    object query_produtosultimacompra: TDateField
      AutoGenerateValue = arDefault
  ...
  object query_entrada: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from entrada_produtos')
    Left = 448
    Top = 112
    object query_entradaid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    ...
    object query_entradaproduto: TStringField
    ...
    object query_entradaquantidade: TIntegerField
      DisplayLabel = 'QUANTIDADE'
      FieldName = 'quantidade'
      Origin = 'quantidade'
      Required = True
    end
    object query_entradavalor: TBCDField
      DisplayLabel = 'VALOR '
      FieldName = 'valor'
      Origin = 'valor'
      Required = True
    ...
    object query_entradatotal: TBCDField
      AutoGenerateValue = arDefault
      DisplayLabel = 'TOTAL'
      DisplayWidth = 20
      FieldName = 'total'
    ...
    object query_entradafornecedor: TIntegerField
    ...
    object query_entradadata: TDateField
      DisplayLabel = 'DATA DA COMPRA'
      FieldName = 'data'
      Origin = 'data'
      Required = True
    end
    object query_entradaid_produto: TIntegerField
  ...
  object DSEntrada: TDataSource
    DataSet = query_entrada
    Left = 448
    Top = 168
  end
  object fb_saida: TFDTable
    Connection = fd
  ...
  object query_saida: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from saida_produtos')
    Left = 520
    Top = 112
    object query_saidaid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    ...
    object query_saidaproduto: TStringField
      DisplayLabel = 'PRODUTOS'
      DisplayWidth = 45
      FieldName = 'produto'
      Origin = 'produto'
    ...
    object query_saidaquantidade: TIntegerField
      DisplayLabel = 'QUANTIDADE'
      FieldName = 'quantidade'
      Origin = 'quantidade'
      Required = True
    end
    object query_saidamotivo: TStringField
      DisplayLabel = 'DESCRI'#199#195'O DA SA'#205'DA'
      FieldName = 'motivo'
      Origin = 'motivo'
      Required = True
      Size = 25
    end
    object query_saidadata: TDateField
      DisplayLabel = 'DATA DO REGISTRO'
      FieldName = 'data'
      Origin = 'data'
      Required = True
    end
    object query_saidaid_produto: TIntegerField
      FieldName = 'id_produto'
      Origin = 'id_produto'
      Required = True
      Visible = False
  ...
  object query_vendas: TFDQuery
    ...
    object query_vendasfuncionario: TStringField
      DisplayLabel = 'OPERADOR DE CAIXA'
      DisplayWidth = 18
    ...
    object query_vendasid_caixa: TIntegerField
      DisplayLabel = 'N'#176' CAIXA'
      FieldName = 'id_caixa'
      Origin = 'id_caixa'
    end
  end
  ...
  object fb_detalhes_vendas: TFDTable
    Connection = fd
  ...
  object query_detalhes_vendas: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from detalhes_vendas')
    Left = 136
    Top = 296
    object query_detalhes_vendasid: TFDAutoIncField
      Alignment = taCenter
      DisplayLabel = '     C'#211'DIGO'
      DisplayWidth = 9
      FieldName = 'id'
    ...
    object query_detalhes_vendasid_venda: TIntegerField
      FieldName = 'id_venda'
      Origin = 'id_venda'
      Required = True
      Visible = False
    end
    object query_detalhes_vendasid_produto: TIntegerField
    ...
    object query_detalhes_vendasproduto: TStringField
      DisplayLabel = '  DESCRO'#199#195'O DO PRODUTO'
      DisplayWidth = 18
      FieldName = 'produto'
      Origin = 'produto'
      Required = True
    ...
    object query_detalhes_vendasquantidade: TIntegerField
      Alignment = taCenter
      DisplayLabel = 'QUANTIDADE'
      DisplayWidth = 8
      FieldName = 'quantidade'
    ...
    object query_detalhes_vendasvalor: TBCDField
      Alignment = taCenter
      DisplayLabel = '       V. U.'
      DisplayWidth = 8
      FieldName = 'valor'
    ...
    object query_detalhes_vendastotal: TBCDField
      Alignment = taLeftJustify
    ...
    object query_detalhes_vendasfuncionario: TStringField
      FieldName = 'funcionario'
      Origin = 'funcionario'
      Required = True
      Visible = False
    ...
    object query_detalhes_vendasdata: TDateField
      FieldName = 'data'
      Origin = 'data'
      Required = True
      Visible = False
  ...
  object DSDetVendas: TDataSource
    DataSet = query_detalhes_vendas
    Left = 136
    Top = 352
  end
  object fb_movi: TFDTable
    IndexFieldNames = 'id'
    Connection = fd
    UpdateOptions.UpdateTableName = 'pdv.movimentacao'
    TableName = 'pdv.movimentacao'
    Left = 232
    Top = 232
  end
  ...
  object query_gastos: TFDQuery
    ...
    object query_gastosid_caixa: TIntegerField
      DisplayLabel = 'N'#176' CAIXA'
      DisplayWidth = 12
      FieldName = 'id_caixa'
      Origin = 'id_caixa'
  ...
  object rel_comprovante: TfrxReport
    ...
    ReportOptions.CreateDate = 44086.981527557900000000
    ReportOptions.LastChange = 44174.709122569450000000
    ...
    Datasets = <
      item
        DataSet = DS_caixas
        DataSetName = 'rel_caixas'
      end
      item
        DataSet = rel_det_vendas
        DataSetName = 'rel_det_vendas'
      end
      item
        DataSet = DS_vendas
        DataSetName = 'rel_vendas'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object Header1: TfrxHeader
        ...
        object rel_vendasid: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object rel_vendasvalor: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 302.362400000000000000
          Top = 105.826840000000000000
        ...
        object rel_vendasdesconto: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 302.362400000000000000
          Top = 120.944960000000000000
        ...
        object rel_vendasvalor_recebido: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_vendas."valor_recebido"]')
          ParentFont = False
        end
        object rel_vendastroco: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 306.141930000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'rel_det_vendas'
        RowCount = 0
        object rel_det_vendasproduto: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 52.913420000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_det_vendas."produto"]')
          ParentFont = False
        end
        object rel_det_vendasvalor: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 253.228510000000000000
          Top = 3.779530000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_det_vendas."valor"]')
          ParentFont = False
        end
        object rel_det_vendastotal: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 332.598640000000000000
          Top = 3.779530000000000000
        ...
        object rel_det_vendasquantidade: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_det_vendas."quantidade"]')
          ParentFont = False
        end
        object rel_det_vendasid: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object Footer1: TfrxFooter
        ...
        object Memo22: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '.COM SOLU'#199#213'ES EM SISTEMAS E WEB DESIGNER')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object rel_det_vendasfuncionario: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_det_vendas."funcionario"]')
          ParentFont = False
        end
        object rel_caixasnum_caixa: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 102.047310000000000000
          Top = 162.519790000000000000
        ...
        object rel_vendasvalor1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object rel_vendasvalor_recebido1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 325.039580000000000000
          Top = 64.252010000000000000
        ...
        object rel_vendastroco1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 325.039580000000000000
          Top = 90.708720000000000000
  ...
  object DS_vendas: TfrxDBDataset
    UserName = 'rel_vendas'
  ...
  object query_caixa: TFDQuery
    ...
    object query_caixadata_fec: TDateField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Data Fechamento'
      FieldName = 'data_fec'
      Origin = 'data_fec'
    end
    object query_caixahora_fec: TTimeField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Hora Fechamento'
      FieldName = 'hora_fec'
      Origin = 'hora_fec'
    end
    object query_caixavalor_fec: TBCDField
      AutoGenerateValue = arDefault
    ...
    object query_caixafuncionario_fec: TStringField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Gerente'
      FieldName = 'funcionario_fec'
      Origin = 'funcionario_fec'
      Size = 25
    end
    ...
    object query_caixavalor_gasto: TBCDField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Gastos/Retirada'
  ...
  object rel_caixa: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44090.471408750000000000
    ReportOptions.LastChange = 44172.455973171290000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData2: TfrxMasterData
        ...
        DataSetName = 'rel_caixas'
        RowCount = 0
        object rel_caixasdata_abertura: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Top = 3.779530000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[rel_caixas."data_abertura"]')
          ParentFont = False
        end
        object rel_caixasfuncionario_abertura: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[rel_caixas."funcionario_abertura"]')
          ParentFont = False
        end
        object rel_caixasvalor_abertura: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[rel_caixas."valor_abertura"]')
          ParentFont = False
        end
        object rel_caixasvalor_vendido: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[rel_caixas."valor_vendido"]')
          ParentFont = False
        end
        object rel_caixasvalor_quebra: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object rel_caixasoperador: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo15: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'DESENVOLVIDO POR SILVEIRAS DRIVERS - 2020')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object DS_caixas: TfrxDBDataset
    UserName = 'rel_caixas'
    CloseDataSource = False
    DataSet = query_caixa
    BCDToCurrency = False
  ...
  object rel_movi: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44090.974219398200000000
    ReportOptions.LastChange = 44172.456904259260000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo15: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '.COM SOLU'#199#213'ES EM SISTEMAS E WEB DESIGNER 2020'
            '')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'DS_movi'
        RowCount = 0
        object DS_movitipo: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object DS_movimovimento: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object DS_movivalor: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object DS_movifuncionario: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object DS_movidata: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object query_tot_entrada: TFDQuery
    Connection = fd
    Left = 472
    Top = 324
  end
  object query_tot_saida: TFDQuery
    Connection = fd
    Left = 478
    Top = 240
  end
  object rel_produtos: TfrxReport
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44091.025131076400000000
    ReportOptions.LastChange = 44172.456512268520000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object DSprodutosestoque: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 408.189240000000000000
          Top = 3.779530000000000000
        ...
        object DSprodutoscodigo: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object DSprodutosnome: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 7.559060000000000000
          Top = 3.779530000000000000
        ...
        object DSprodutosvalor: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo2: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '.COM SOLU'#199#213'ES EM SISTEMA E WEB DESIGNER 2020')
        end
        object Memo3: TfrxMemoView
          AllowVectorExport = True
  ...
  object DS_protudos: TfrxDBDataset
    UserName = 'DSprodutos'
    CloseDataSource = False
    DataSet = query_produtos
    BCDToCurrency = False
  ...
  object fb_pedidos: TFDTable
    IndexFieldNames = 'id'
    Connection = fd
    UpdateOptions.UpdateTableName = 'cadastro_cliente'
    TableName = 'cadastro_cliente'
    Left = 40
    Top = 408
  end
  object query_cliente: TFDQuery
    ...
    object query_clientecpf: TStringField
      AutoGenerateValue = arDefault
      DisplayLabel = 'CPF'
      FieldName = 'cpf'
      Origin = 'cpf'
    ...
    object query_clientecnpj: TStringField
      AutoGenerateValue = arDefault
      DisplayLabel = 'CNPJ'
      DisplayWidth = 18
      FieldName = 'cnpj'
    ...
    object query_clientedata: TDateField
      DisplayLabel = 'DATA'
      FieldName = 'data'
      Origin = 'data'
      Required = True
  ...
  object DS_Cliente: TfrxDBDataset
    UserName = 'rel_clientes'
    CloseDataSource = False
    DataSet = query_cliente
    BCDToCurrency = False
    Left = 304
  ...
  object rel_entrega: TfrxReport
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44086.981527557900000000
    ReportOptions.LastChange = 44174.708887974540000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object Footer1: TfrxFooter
        ...
        object rel_clientesnome: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object rel_clientesendereco: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 120.944960000000000000
          Top = 151.181200000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_clientes."endereco"]')
          ParentFont = False
        end
        object rel_clientestelefone: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 120.944960000000000000
          Top = 166.299320000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_clientes."telefone"]')
          ParentFont = False
        end
        object rel_clientescpf: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 120.944960000000000000
          Top = 181.417440000000000000
        ...
        object rel_clientescnpj: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 120.944960000000000000
          Top = 196.535560000000000000
        ...
        object rel_vendasdesconto1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 328.819110000000000000
          Top = 37.795300000000000000
  ...
  object query_coringavendas: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from vendas')
    Left = 128
    Top = 464
    object query_coringavendasid_caixa: TIntegerField
      Alignment = taCenter
      DisplayLabel = '   ID CAIXA'
      FieldName = 'id_caixa'
      Origin = 'id_caixa'
      Required = True
    end
    object query_coringavendasfuncionario: TStringField
      DisplayLabel = 'FUNCION'#193'RIO'
      DisplayWidth = 20
      FieldName = 'funcionario'
      Origin = 'funcionario'
    ...
    object query_coringavendasid: TFDAutoIncField
      DisplayLabel = 'ID'
      DisplayWidth = 5
      FieldName = 'id'
      Origin = 'id'
    ...
    object query_coringavendasvalor: TBCDField
      Alignment = taCenter
    ...
    object query_coringavendasdesconto: TBCDField
      Alignment = taCenter
      DisplayLabel = '  DESCONTO'
      FieldName = 'desconto'
      Origin = 'desconto'
    ...
    object query_coringavendasvalor_recebido: TBCDField
      Alignment = taCenter
    ...
    object query_coringavendastroco: TBCDField
      Alignment = taCenter
      DisplayLabel = '     TROCO'
      FieldName = 'troco'
      Origin = 'troco'
    ...
    object query_coringavendasdata: TDateField
      Alignment = taCenter
      DisplayLabel = '       DATA'
      DisplayWidth = 12
      FieldName = 'data'
    ...
    object query_coringavendashora: TTimeField
      DisplayLabel = '   HORA'
      DisplayWidth = 9
      FieldName = 'hora'
      Origin = 'hora'
    ...
    object query_coringavendasstatus: TStringField
      Alignment = taCenter
      DisplayLabel = '       STATUS'
      DisplayWidth = 14
      FieldName = 'status'
  ...
  object DS_coringavendas: TDataSource
    DataSet = query_coringavendas
    Left = 128
    Top = 528
  end
  object query_caixacoringa: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from caixa')
    Left = 136
    Top = 592
    object query_caixacoringaoperador: TStringField
      DisplayLabel = 'OPERADOR DE CAIXA'
      DisplayWidth = 19
      FieldName = 'operador'
      Origin = 'operador'
    ...
    object query_caixacoringafuncionario_abertura: TStringField
      DisplayLabel = 'GERENTE'
      DisplayWidth = 22
      FieldName = 'funcionario_abertura'
      Origin = 'funcionario_abertura'
    ...
    object query_caixacoringanum_caixa: TIntegerField
      Alignment = taCenter
      DisplayLabel = '  CAIXA'
      DisplayWidth = 8
      FieldName = 'num_caixa'
    ...
    object query_caixacoringavalor_abertura: TBCDField
      Alignment = taCenter
      DisplayLabel = 'FUNDO DE CAIXA'
      DisplayWidth = 14
      FieldName = 'valor_abertura'
      Origin = 'valor_abertura'
      Required = True
    ...
    object query_caixacoringavalor_vendido: TBCDField
      Alignment = taCenter
      AutoGenerateValue = arDefault
      DisplayLabel = '   VENDA TOTAL'
      DisplayWidth = 15
      FieldName = 'valor_vendido'
      Origin = 'valor_vendido'
      currency = True
    ...
    object query_caixacoringavalor_fec: TBCDField
      Alignment = taCenter
      AutoGenerateValue = arDefault
    ...
    object query_caixacoringaid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    ...
    object query_caixacoringadata_abertura: TDateField
      Alignment = taCenter
      DisplayLabel = 'DATA ABERTURA'
      FieldName = 'data_abertura'
      Origin = 'data_abertura'
    ...
    object query_caixacoringahora_abertura: TTimeField
      Alignment = taCenter
      DisplayLabel = 'HORA ABERTURA'
      FieldName = 'hora_abertura'
      Origin = 'hora_abertura'
    ...
    object query_caixacoringadata_fec: TDateField
      AutoGenerateValue = arDefault
      DisplayLabel = 'FECHAMENTO'
      DisplayWidth = 12
      FieldName = 'data_fec'
    ...
    object query_caixacoringahora_fec: TTimeField
      Alignment = taCenter
      AutoGenerateValue = arDefault
      DisplayLabel = 'HORA FECHAMENTO'
      DisplayWidth = 12
    ...
    object query_caixacoringavalor_quebra: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valor_quebra'
      Origin = 'valor_quebra'
      Visible = False
    ...
    object query_caixacoringafuncionario_fec: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'funcionario_fec'
      Origin = 'funcionario_fec'
      Visible = False
    ...
    object query_caixacoringastatus: TStringField
      FieldName = 'status'
      Origin = 'status'
      Required = True
      Visible = False
    ...
    object query_caixacoringavalor_gasto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valor_gasto'
      LookupCache = True
      Origin = 'valor_gasto'
  ...
  object DS_caixacoringa: TDataSource
    DataSet = query_caixacoringa
    Left = 136
    Top = 648
  end
  object rel_Vendas: TfrxReport
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44090.974219398200000000
    ReportOptions.LastChange = 44172.453651192130000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo15: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'DESENVOLVIDO POR ".COM TECNOLOGIA E DESIGNER" - 2020')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo17: TfrxMemoView
      ...
      object MasterData1: TfrxMasterData
        ...
        object rel_vendasdata: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 578.268090000000000000
          Top = 7.559060000000000000
        ...
        object rel_vendasfuncionario: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 321.260050000000000000
          Top = 7.559060000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[rel_vendas."funcionario"]')
        end
        object rel_vendasstatus: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 11.338590000000000000
          Top = 7.559060000000000000
        ...
        object rel_vendashora: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object rel_fechamento: TfrxReport
    Version = '6.2.1'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick, pbCopy, pbSelection]
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44152.717851805600000000
    ReportOptions.LastChange = 44172.454164328700000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object rel_caixasvalor_gasto: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
      ...
      object rel_caixasvalor_fec: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
        Left = 275.905690000000000000
        Top = 257.008040000000000000
        ...
        Frame.Typ = []
        Memo.UTF8W = (
          '[rel_caixas."valor_fec"]')
        ParentFont = False
      end
      object rel_caixashora_abertura: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
        Left = 275.905690000000000000
        Top = 366.614410000000000000
        ...
        Frame.Typ = []
        Memo.UTF8W = (
          '[rel_caixas."hora_abertura"]')
        ParentFont = False
      end
      object rel_caixasdata_fec: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
        Left = 275.905690000000000000
        Top = 385.512060000000000000
      ...
      object rel_caixashora_fec: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
        Left = 275.905690000000000000
        Top = 404.409710000000000000
      ...
      object Memo22: TfrxMemoView
        ...
        Frame.Typ = []
        Memo.UTF8W = (
          '.COM TECNOLOGIA E WEB DESIGNER')
        ParentFont = False
        VAlign = vaCenter
      end
      object rel_caixasid: TfrxMemoView
        IndexTag = 1
        AllowVectorExport = True
        Left = 275.905690000000000000
        Top = 181.417440000000000000
  ...
  object DS_Gastos: TfrxDBDataset
  ...
  object query_coringa1: TFDQuery
    Connection = fd
    Left = 360
    Top = 8
  end
  object rel_retirada: TfrxReport
    Version = '6.2.1'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick, pbCopy, pbSelection]
    ...
    PrintOptions.Printer = 'Default'
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 44153.595347766200000000
    ReportOptions.LastChange = 44172.454624212970000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object Memo26: TfrxMemoView
        ...
        Frame.Typ = []
        Memo.UTF8W = (
          '.COM SOLU'#199#213'ES EM SISTEMAS E DESIGNER')
        ParentFont = False
      end
      object Memo27: TfrxMemoView
        AllowVectorExport = True
  ...
  object query_coringa_venda: TFDQuery
    Connection = fd
    Left = 48
    Top = 760
  end
